...
const TrackForm = ({ editFormData, onSubmitTrack, setShow }) => {
  ...
  const defaultValues = editFormData
    ? {
        ...editFormData,
        minute: editFormData?.duration.split(":")[0],
        second: editFormData?.duration.split(":")[1],
      }
    : {
        trackType: "Lyrical",
        trackTitle: "",
  ...
  }, [session, getValues, reset, editFormData]);
