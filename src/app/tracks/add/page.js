    ...
    <>
      ...
      <main className="px-3 py-2 xs:px-5 xs:py-3 md:px-20 md:py-10">
        <div className="asset">
          ...
          <div className="input-area px-3 py-2 xs:px-5 xs:py-3 md:px-20 md:py-10 border-2">
            <div className="input flex flex-col">
              ...
              <div className="my-1 bg-gray-200 outline-none px-2 py-2 border-l-8 border-blue-700">
                <label
                  className="bg-white py-[6px] items-center rounded-full cursor-pointer flex justify-center "
                  htmlFor="music"
                >
